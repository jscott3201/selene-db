...
pub(crate) fn polysemous_l2_entry() -> VectorCorpusEntry {
    VectorCorpusEntry {
        slug: "pq-polysemous-l2",
        description: "PQ asymmetric L2 search with polysemous code permutation.",
        graph: VectorCorpusGraph::PqTrainingL2_256,
        config: cfg(
            8,
            VectorMetricMirror::L2,
            VectorQuantizationSpec::PQ_POLYSEMOUS,
        ),
        invocation: search(
            &[0.2, -0.4, 0.1, 0.8, -0.2, 0.3, -0.7, 0.5],
            8,
