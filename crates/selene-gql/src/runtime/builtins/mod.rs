...
//! candidate vector scoring, approximate vector-search, batched approximate
//! vector-search, vector-index stats, and vector-index procedures are new native
...
pub(super) const BUILTIN_SPECS: [BuiltinSpec; 18] = [
    BuiltinSpec {
        name: &["selene", "health"],
