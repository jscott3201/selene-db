...
//! across statements.
//!
//! STEP 2 registers the 19 `algo.*` procedures. The 39 platform
...
impl BuiltinProcedureRegistry {
    ...
    pub fn new() -> Self {
        ...
        // `algo.*` procedures first (handles 1..=19), then the 39 `selene.*`
        // platform built-ins (handles 20..=58), continuing the same monotonic
...
mod tests {
    ...
    fn handles_are_unique_and_one_based() {
        ...
        assert_eq!(handles, (1..=58).collect::<Vec<_>>());
    }
