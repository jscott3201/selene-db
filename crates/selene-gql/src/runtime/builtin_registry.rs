...
//! across statements.
//!
//! STEP 2 registers the 19 `algo.*` procedures. The 38 platform
...
impl BuiltinProcedureRegistry {
    ...
    pub fn new() -> Self {
        ...
        // `algo.*` procedures first (handles 1..=19), then the 38 `selene.*`
        // platform built-ins (handles 20..=57), continuing the same monotonic
...
mod tests {
    ...
    fn handles_are_unique_and_one_based() {
        ...
        assert_eq!(handles, (1..=57).collect::<Vec<_>>());
    }
