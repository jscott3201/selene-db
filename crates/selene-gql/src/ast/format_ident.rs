...
const KEYWORDS: &[&str] = &[
    ...
    "CONTAINS", "COS", "COSH", "COT", "COUNT", "CREATE", "DATE", "DATETIME",
    "DAY", "DEC", "DECIMAL", "DEFAULT", "DEGREES", "DELETE", "DESC",
    "DESTINATION", "DETACH", "DICTIONARY", "DIFFERENT", "DIRECTED", "DISTINCT",
    "DOUBLE", "DROP", "DURATION", "EDGE", "EDGES", "ELEMENTS", "ELSE",
    "ENCODING", "END", "ENDS", "EXCEPT", "EXISTS", "EXP", "EXTENDS", "FALSE",
    "FILL", "FILTER", "FINISH", "FIRST", "FLOAT", "FLOOR", "FOR", "FROM",
    ...
    "LIST", "LN", "LOCAL", "LOG", "LOG10", "LOWER", "LTRIM", "MATCH", "MAX",
    "MERGE", "MIN", "MINUTE", "MOD", "MONTH", "NEXT", "NFC", "NFD", "NFKC",
    "NFKD", "NO", "NODE", "NODETACH", "NONE", "NORMALIZE", "NORMALIZED",
    "NOT", "NOTHING", "NULL", "NULLS", "OCTET_LENGTH", "OF", "OFFSET", "ON",
