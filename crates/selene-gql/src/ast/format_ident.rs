...
const KEYWORDS: &[&str] = &[
    ...
    "OFFSET", "ON", "ONLY", "OPEN", "OPTIONAL", "OR", "ORDER", "OTHERWISE",
    "PARAMETER", "PARAMETERS", "PARTITION", "PATH", "PATH_LENGTH", "PATHS",
    "PERCENTILE_CONT", "PERCENTILE_DISC", "POWER", "PRECISION", "PROCEDURE",
    "PRODUCT", "PROJECT", "PROPERTY_EXISTS", "QUERY", "RADIANS", "REAL",
    "RECORD", "RECORDS", "REDUCE", "REFERENCE", "REMOVE", "RENAME",
