...
use selene_persist::{
    COMPRESS_THRESHOLD, DEFAULT_WAL_FILE_NAME, FLAG_PAYLOAD_COMPRESSED, SyncPolicy, WalCompression,
...
fn bench_wal_payload_compression_policy_no_fsync(c: &mut Criterion) {
...
fn bench_wal_payload_compression_policy_replay(c: &mut Criterion) {
...
criterion_group! {
    ...
    targets = bench_wal_append_single, bench_wal_append_batch_1000,
        ...
        bench_wal_payload_compression_policy_no_fsync,
        bench_wal_payload_compression_policy_replay, bench_wal_payload_shape_replay,
        bench_wal_replay
}
