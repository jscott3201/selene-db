...
use super::sections::{
    CompositeSchemaEntry, CompositeSchemaKey, SchemaEntry, SchemaEntryV1, SchemaKey,
    decode_composite_schemas, decode_edges, decode_graph_types, decode_meta, decode_nodes,
    decode_schemas, encode_composite_schemas, encode_edges, encode_graph_types, encode_meta,
    encode_nodes, ensure_section_within_cap,
};
use super::*;
use crate::graph::{CompositePropertyIndexEntry, PropertyIndexEntry};
use crate::typed_index::TypedIndex;
use crate::{
    CompositeTypedIndex, DurableProvider, GraphError, SeleneGraph, SharedGraph, TypedIndexKind,
};
...
#[test]
fn cpix_round_trip_preserves_composite_registration_metadata() {
...
#[test]
fn cpix_decode_rejects_duplicate_canonical_property_sets() {
