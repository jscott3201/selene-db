...
- The newly listed JSON/text/vector helper paths are Part 2 implementation owners, not a fourth part, D-021 exception, dependency inversion, public row bridge, or compatibility promise.
