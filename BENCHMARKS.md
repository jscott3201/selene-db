...
| `algo/triangle_count` | 10k | 595.12 µs | 590.86 µs | Auto now stays sequential below the 16,384-row threshold. |
| `algo/triangle_count` | 50k | 3.018 ms | 2.430 ms | Auto still uses Rayon once the row count clears the threshold. |
| `algo/triangle_count` | 100k | 6.182 ms | 4.813 ms | Thresholded Auto preserves the large-row parallel win. |
